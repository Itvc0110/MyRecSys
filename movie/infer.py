...
if __name__ == "__main__":
    ...
    infer_user_movie_path = os.path.join(project_root, "movie/infer_data/infer_user_movie.csv")
    ...
    content_movie_path = os.path.join(project_root, "movie/infer_data/merged_content_movies.csv")
